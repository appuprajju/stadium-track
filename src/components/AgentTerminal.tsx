    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
      ...
      <div className="glass-panel rounded-2xl p-6 flex flex-col justify-between">
        <div>
          ...
          <p className="text-xs text-slate-400 mb-4">Inject synthetic CCTV & IoT events to trigger Multi-Agent cascades</p>
      ...
      <div className="glass-panel rounded-2xl p-6 flex flex-col">
        ...
        <p className="text-xs text-slate-400 mb-4">Active operational alerts generated by autonomous sensors</p>
              ...
              {activeIncident.status === 'PENDING_APPROVAL' ? (
                <div className="bg-gradient-to-br from-amber-500/10 to-red-500/5 border border-amber-500/30 rounded-xl p-4 relative overflow-hidden">
                  ...
                  <div className="flex gap-2">
                    <button 
                      onClick={() => onApproveIncident(activeIncident.id)}
                      className="flex-1 py-1.5 bg-amber-500 hover:bg-amber-400 text-slate-950 text-xs font-extrabold rounded-lg transition-colors text-glow-gold"
                    >
                      Authorize Action
                    </button>
                    <button className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-400 text-xs font-semibold rounded-lg transition-colors border border-slate-700">
                      Decline
                    </button>
                  </div>
                </div>
